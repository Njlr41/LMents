...
<div class="login-button">
    <button on:click={login_button} class="gsi-material-button">
        ...
        <div class="gsi-material-button-content-wrapper">
            ...
            <span class="gsi-material-button-contents">Sign in with Google (Mobile)</span>
...
<!-- Button is taken from Google Sign in Branding Guidelines-->
